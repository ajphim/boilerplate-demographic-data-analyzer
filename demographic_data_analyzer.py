...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = round((total_bachelors / total_count) * 100, 1)
    ...
    country_earning_more_than_50k = df[df['salary'] == '>50K']['native-country'].value_counts()
    highest_earning_country = (country_earning_more_than_50k / country_counts * 100).idxmax()
    highest_earning_country_percentage = round((country_earning_more_than_50k / country_counts * 100).max(), 1) 
